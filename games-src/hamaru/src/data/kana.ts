/**
 * Static kana datasets for the Learning Hub.
 *
 * Hiragana + Katakana as { kana, romaji } pairs (gojūon + dakuten/handakuten +
 * common youon). Romaji follows the same Hepburn mapping used server-side in
 * server/games/hamaru/jmdict-service.js. Kept client-side because the set is
 * small, fixed, and needed offline by every learning mode.
 */
...
export type LearningCategory = 'hiragana' | 'katakana' | 'kanji' | 'vocab';
