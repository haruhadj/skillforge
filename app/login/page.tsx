...
export default function LoginPage() {
  ...
  const { currentUser, login, signInWithFacebook } = useAuth()
        ...
        <div className="glass p-10 sm:p-12">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white dark:bg-gray-800 px-3 text-slate-500 dark:text-gray-400">or continue with</span>
            </div>
          </div>
