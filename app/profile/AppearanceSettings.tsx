...
import { AccentTheme } from '@/app/types'
...
/**
 * Appearance settings — theme (dark/light) + accent color. Applies changes to the
...
export default function AppearanceSettings({ uid }: { uid: string }) {
  const { darkMode, setDarkMode, accent, setAccent } = useTheme()
