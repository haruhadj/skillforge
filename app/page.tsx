      ...
      <div className="w-full max-w-lg animate-scale-in">
        <div className="glass p-10 sm:p-12">
          ...
          <div className="mt-12 space-y-4">
            <button
              className="w-full btn-outline flex items-center justify-center gap-3 hover:-translate-y-0.5 active:translate-y-0"
            ...
            <button
              ...
              type="button"
            >
              <svg className="w-5 h-5 flex-shrink-0 text-blue-600" viewBox="0 0 24 24" fill="currentColor">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
              <span>{isFacebookLoading ? 'Signing in...' : 'Continue with Facebook'}</span>
            </button>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white dark:bg-gray-800 text-slate-500 dark:text-gray-400">or</span>
              </div>
            </div>

            <div className="grid gap-4 sm:grid-cols-2">
              <Link href="/login" className="btn-primary text-center hover:-translate-y-0.5 active:translate-y-0">
                Login
              </Link>

              <Link href="/signup" className="btn-secondary text-center hover:-translate-y-0.5 active:translate-y-0">
                Create Account
              </Link>
            </div>
          </div>
