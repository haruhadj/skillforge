...
export default function HomePage() {
  ...
  const handleTiktokSignIn = () => { setIsTiktokLoading(true); window.location.href = '/api/auth/tiktok' }
  const handleTwitterSignIn = () => { setIsTwitterLoading(true); window.location.href = '/api/auth/twitter' }
  const handleFacebookSignIn = () => { setIsFacebookLoading(true); window.location.href = '/api/auth/facebook' }
  const handleDiscordSignIn = () => { setIsDiscordLoading(true); window.location.href = '/api/auth/discord' }

  const hasSecondaryOAuth = oauthConfig.github || oauthConfig.twitter || oauthConfig.discord || oauthConfig.facebook || oauthConfig.tiktok
              ...
              <>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  ...
                  {oauthConfig.facebook && (
                    <Button
                      variant="outline"
                      className="h-10 gap-1.5 text-xs font-medium px-3 hover:border-[#1877F2]/40 hover:bg-[#1877F2]/5"
                    ...
                    >
                      ...
                      <span>{isFacebookLoading ? '…' : 'Facebook'}</span>
                    </Button>
                  )}
                  {oauthConfig.tiktok && (
                    <Button
